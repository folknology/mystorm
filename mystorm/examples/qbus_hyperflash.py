...
from ..core.hyperflash_write import HyperflashWrite, HyperbusPins

import time

LED_BLADE = 1
led_blade_pins = "leds6"
...
class QbusHf(Elaboratable):
    def elaborate(self, platform):
        ...
        leds6 = platform.request(led_blade_pins)
...
if __name__ == "__main__":
    ...
    platform.add_blade(led_blade_pins, LED_BLADE,  {"all":("led","o")}, invert=True)
